...
Plugin URI: https://pagevisitcounter.com/pricing/?utm_source=WordPress&utm_medium=Community&utm_campaign=Get+premium+version+of+Page+Visit+Counter&utm_term=WordPress+Website&utm_content=Bio+link
...
The features of advanced Shortcode designer are:
- Text Settings
- Visibility options
- Labels & Icons
- Shortcode Templates
- Saving Shortcodes *Premium users only

= Advanced Page Visit Counter Settings

- Post Types
- Exclude
- Show Counter on Front End
- Anonymize IP
...
= 5.0.8. - 15.12.2021 =
* Improvement & Fixes and removed promotion popup.

= 6.0.0. - 08.04.2022 =
* Major security improvements, added nonces, sanitisation methods and added advanced security layers for the security of the plugin.

= 6.0.1. - 09.04.2022 =
* Security improvements, sanitisation improvements and security updates.

= 6.0.2. - 12.04.2022 =
* Security improvements and security updates.
...
= 6.0.8. - 12.05.2022 =
* Translation fixes and plugin name updates, and other security updates.
...
= 7.1.0 = - 09.07.2023 =
* Reverted to old version of the plugin.

= 7.1.1 = - 19.07.2023 =
* Fixed XSS vulnerability issue in Freemius SDK & tested with WordPress 6.3 #74 