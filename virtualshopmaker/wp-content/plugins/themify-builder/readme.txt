...
= 7.0.3 (2023.06.13) =
* Fix: Builder: Gutenberg video block poster image is ignored
* Fix: Builder: In backend editor, pasting into Row options breaks the Builder interface
* Fix: Builder: Background image relative patch in css
* Fix: Builder: Overlay Content module uses % for Width & Height when px is selected
* Change: Builder: enable position options when Position is set to Relative
* Fix: Builder: Video module full screen option not working for Youtube videos
* Fix: Builder: UI > Padding: range input click freeze Chrome on Mac M2
* Fix: Builder: Firefox: Hover makes elements disappear
* Fix: Builder: Google fonts missing font family error
* Fix: Builder: Audio live stream doesn't work
...
* Fix: Builder: Auto slide doesn't follow wrap option
* Fix: Builder: The row bottom frame appears reverted
* Fix: Builder: Gallery Module: The image Gutter option does not work
* Fix: Builder: Negative Box-shadow Spread doesn't work
* Fix: Builder: Can't save post/page/product in backend if Classic Editor & ACF activated
* Fix: Builder: Menu burger icon doesn't inherit text-align
* Fix: Builder: Background slider best fit not working
* Change: Builder: Remove some hover styling options for less html size
