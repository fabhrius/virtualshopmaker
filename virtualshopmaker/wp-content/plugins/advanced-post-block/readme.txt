...
Advanced Post Block is a useful plugin for the new WordPress Gutenberg block editor. It added many new features for displaying posts or custom post content on your web page or posts.
...
**[Documentation](https://bplugins.com/docs/advanced-post-block)**
...
- **Post Query:** Filter your posts by queries like post type, categories, posts per page, and post order.
...
- **Meta Author Link Toggle:** Show the meta author with/without the link.

- **Date Format:** Date format option for the meta-date.
...
= 1.10.0 =
* Add content/texts height option
